...
public class BinaryHeapTest {
    ...
    public void testBinaryHeap () {
        ...
        if (h.pop().heapValue != 44.683983f) throw new RuntimeException("Should be 44.683983");
        ...
        if (h.pop().heapValue != 95.038086f) throw new RuntimeException("Should be 95.038086");
        h.add(m.get(926.524f));
        if (h.pop().heapValue != 160.47682f) throw new RuntimeException("Should be 160.47682");
        ...
        if (h.pop().heapValue != 189.30789f) throw new RuntimeException("Should be 189.30789");
        h.add(m.get(407.9829f));
        h.add(m.get(1482.5394f));
        h.add(m.get(1135.7894f));
        h.add(m.get(362.44937f));
        if (h.pop().heapValue != 313.3819f) throw new RuntimeException("Should be 313.3819");
        h.add(m.get(725.86615f));
        h.add(m.get(1656.2006f));
        h.add(m.get(490.8201f));
        if (h.pop().heapValue != 342.5846f) throw new RuntimeException("Should be 342.5846");
        ...
        if (h.pop().heapValue != 362.44937f) throw new RuntimeException("Should be 362.44937");
        ...
        if (h.pop().heapValue != 373.29028f) throw new RuntimeException("Should be 373.29028");
        ...
        if (h.pop().heapValue != 377.55692f) throw new RuntimeException("Should be 377.55692");
        h.add(m.get(973.9379f));
        h.remove(m.get(723.18396f));
        h.add(m.get(619.83624f));
        h.remove(m.get(1656.2006f));
        h.add(m.get(1547.9089f));
        if (h.pop().heapValue != 379.61304f) throw new RuntimeException("Should be 379.61304");
        ...
        if (h.pop().heapValue != 388.60376f) throw new RuntimeException("Should be 388.60376");
        ...
        if (h.pop().heapValue != 396.49918f) throw new RuntimeException("Should be 396.49918");
        h.remove(m.get(619.83624f));
        h.add(m.get(548.92786f));
        h.remove(m.get(924.88995f));
        h.add(m.get(905.3478f));
        if (h.pop().heapValue != 407.9829f) throw new RuntimeException("Should be 407.9829");
        h.remove(m.get(440.83838f));
        h.add(m.get(436.48087f));
        if (h.pop().heapValue != 417.02042f) throw new RuntimeException("Should be 417.02042");
        h.remove(m.get(1040.5143f));
        h.add(m.get(950.6953f));
        h.add(m.get(992.51624f));
        h.add(m.get(808.5153f));
        if (h.pop().heapValue != 430.27383f) throw new RuntimeException("Should be 430.27383");
        h.add(m.get(876.47845f));
        h.add(m.get(472.963f));
        if (h.pop().heapValue != 436.48087f) throw new RuntimeException("Should be 436.48087");
        h.remove(m.get(465.81775f));
        h.add(m.get(461.85135f));
        h.add(m.get(1552.4479f));
        if (h.pop().heapValue != 439.67096f) throw new RuntimeException("Should be 439.67096");
        if (h.pop().heapValue != 461.85135f) throw new RuntimeException("Should be 461.85135");
        ...
        if (h.pop().heapValue != 472.963f) throw new RuntimeException("Should be 472.963");
        if (h.pop().heapValue != 487.93192f) throw new RuntimeException("Should be 487.93192");
        h.add(m.get(548.7671f));
        if (h.pop().heapValue != 548.7671f) throw new RuntimeException("Should be 548.7671");
        h.add(m.get(1437.1154f));
        h.add(m.get(1934.038f));
        h.add(m.get(2401.7002f));
        if (h.pop().heapValue != 548.92786f) throw new RuntimeException("Should be 548.92786");
        h.remove(m.get(973.9379f));
        h.add(m.get(903.2409f));
        h.remove(m.get(1547.9089f));
        h.add(m.get(1481.2589f));
        if (h.pop().heapValue != 598.95935f) throw new RuntimeException("Should be 598.95935");
